...
build/index.js: obj/road_network.o obj/main.o obj/context_menu.o obj/bezier_curve.o obj/movable_point.o obj/road_segment.o raylib/src/libraylib.a | build
...
obj/main.o: src/main.cpp src/road_network.hpp | obj
